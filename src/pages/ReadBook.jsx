                ...
                <div className="container">
                    ...
                    <div className='pt-10 flex justify-center flex-col md:flex-row'>
                        ...
                        <div className='w-full md:w-1/2 p-3'>
                            <p className='text-left text-white text-2xl'>Name: {currentBook.name}</p>
                            <p className='text-left text-white text-2xl'>Author: {currentBook.author}</p>
                            <p className='text-left text-white text-lg'>{currentBook.views} views - {timeAgo(currentBook.created_at)}</p>
                            ...
                            <p className='text-white text-lg bg-green-600 p-5 m-3 hover:cursor-pointer hover:shadow-2xl duration-300'><a href={currentBook.ebook_file} target='_blank'>Read this book</a></p>
                        </div>
                    </div>
                </div>
            </div>
